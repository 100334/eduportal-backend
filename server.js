...
// ============================================
// NEW ADMIN QUIZ GRADING ENDPOINTS
// ============================================
...
// ============================================
// SUBMIT QUIZ ENDPOINT (UPDATED WITH MARKS & FEEDBACK)
// ============================================
...
app.get('/api/teacher/dashboard/stats', authenticateToken, async (req, res) => {
  ...
  // For brevity, we assume you have it; if not, add it back.
});
...
app.listen(PORT, () => {
  ...
  console.log('   POST   /api/quiz/:quizId/submit');   // ← THIS ONE IS NOW PRESENT
